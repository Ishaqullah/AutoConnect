          ...
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <FormControl fullWidth variant="outlined">
                ...
                <Select label="Make" labelId="make-select" id="make-select">
            ...
            <Grid item xs={6}>
              <FormControl fullWidth variant="outlined">
                ...
                <Select label="Model" labelId="model-select" id="model-select">
            ...
            <Grid item xs={6}>
              <FormControl fullWidth variant="outlined">
                ...
                <Select label="City" labelId="city-select" id="city-select">
