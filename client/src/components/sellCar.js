          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <FormControl fullWidth>
                ...
                <Select>
                  <MenuItem value="transmission1">Transmission 1</MenuItem>
                  <MenuItem value="transmission2">Transmission 2</MenuItem>
            ...
            <Grid item xs={12}>
              <FormControl component="fieldset">
                ...
                <FormGroup>
                  <FormControlLabel control={<Checkbox />} label="ABS" />
                  <FormControlLabel control={<Checkbox />} label="Air Bags" />
      ...
      <Card sx={{ marginTop: "20px" }}>
        <CardContent>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <TextField fullWidth label="Secondary Mobile Number (Optional)" />
            </Grid>
          </Grid>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <Typography variant="h6">
            ...
            <Typography variant="caption">
              (Note: The maximum & minimum prices you enter will be confidential
              and hidden from potential customers.)
            </Typography>
          </Typography>
          <Grid container spacing={2}>
            <Grid item xs={6}>
